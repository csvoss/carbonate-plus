...
def check_solution(answer, newest):
    """
    answer, newest :: SMILES strings.
    return :: True if newest and answer are the same.
    """
...
dropdown_list = [
    dropdown_item("Hydrobromination",
                  "HBr in CH<sub>2</sub>Cl<sub>2</sub>",
                  hydrobrominate_it),
    dropdown_item("Hydrochlorination",
                  "HCl in CH<sub>2</sub>Cl<sub>2</sub>",
                  hydrochlorinate_it),
    dropdown_item(MIX,
                  "(no reagents)",
                  mix_it),
    dropdown_item("1-equiv Hydrobromination",
                  "HBr (1 equiv) in CH<sub>2</sub>Cl<sub>2</sub>",
                  hydrobrominate_it_once),
    dropdown_item("1-equiv Hydroiodination",
                  "HI (1 equiv) in CH<sub>2</sub>Cl<sub>2</sub>",
                  hydroiodinate_it_once),
    dropdown_item("1-equiv Hydrochlorination",
                  "HCl (1 equiv) in CH<sub>2</sub>Cl<sub>2</sub>",
                  hydrochlorinate_it_once),
    dropdown_item("Hydroiodination",
                  "HI in CH<sub>2</sub>Cl<sub>2</sub>",
                  hydroiodinate_it),
    dropdown_item("1-equiv Bromination",
                  "Br<sub>2</sub> (1 equiv) in CH<sub>2</sub>Cl<sub>2</sub>",
                  brominate_it_once),
    dropdown_item("1-equiv Iodination",
                  "I<sub>2</sub> (1 equiv) in CH<sub>2</sub>Cl<sub>2</sub>",
                  iodinate_it_once),
    dropdown_item("1-equiv Chlorination",
                  "Cl<sub>2</sub> (1 equiv) in CH<sub>2</sub>Cl<sub>2</sub>",
                  chlorinate_it_once),
    dropdown_item("Bromination",
                  "Br<sub>2</sub> in CH<sub>2</sub>Cl<sub>2</sub>",
                  brominate_it),
    dropdown_item("Iodination",
                  "I<sub>2</sub> in CH<sub>2</sub>Cl<sub>2</sub>",
                  iodinate_it),
    dropdown_item("Chlorination",
                  "Cl<sub>2</sub> in CH<sub>2</sub>Cl<sub>2</sub>",
                  chlorinate_it),
    dropdown_item("Epoxidation",
                  "mCPBA or PhCO<sub>3</sub>H in CH<sub>2</sub>Cl<sub>2</sub>",
                  epoxidate_it),
    dropdown_item("Acid Hydration (Water)",
                  "H<sub>2</sub>SO<sub>4</sub>, H<sub>2</sub>O",
                  acidhydrate_it),
    dropdown_item("Acid Hydration (Water) (HgSO4 accels.)",
                  "H<sub>2</sub>SO<sub>4</sub>, H<sub>2</sub>O, HgSO<sub>4</sub> accels.",
                  acidhydrate_it_hgso4),
    dropdown_item("Acid Hydration (Ethanol)",
                  "H<sub>2</sub>SO<sub>4</sub>, EtOH",
                  acidhydrate_it_ethanol),
    dropdown_item("Acid Hydration (Ethanol) (HgSO4 accels.)",
                  "H<sub>2</sub>SO<sub>4</sub>, EtOH, HgSO<sub>4</sub> accels.",
                  acidhydrate_it_hgso4_ethanol),
    dropdown_item("Acid Hydration (ROH)",
                  "H<sub>2</sub>SO<sub>4</sub>",
                  acidhydrate_it_auto),
    dropdown_item("Acid Hydration (ROH) (HgSO4 accels.)",
                  "H<sub>2</sub>SO<sub>4</sub>, HgSO<sub>4</sub> accels.",
                  acidhydrate_it_hgso4_auto),
    dropdown_item("Bromohydration (H2O)",
                  "Br<sub>2</sub> in H<sub>2</sub>O",
                  bromohydrate_it_water),
    dropdown_item("Bromohydration (EtOH)",
                  "Br<sub>2</sub> in EtOH",
                  bromohydrate_it_ethanol),
    dropdown_item("Bromohydration (ROH)",
                  "Br<sub>2</sub> in ROH",
                  bromohydrate_it_auto),
    dropdown_item("Iodohydration (H2O)",
                  "I<sub>2</sub> in H<sub>2</sub>O",
                  iodohydrate_it_water),
    dropdown_item("Iodohydration (EtOH)",
                  "I<sub>2</sub> in EtOH",
                  iodohydrate_it_ethanol),
    dropdown_item("Iodohydration (ROH)",
                  "I<sub>2</sub> in ROH",
                  iodohydrate_it_auto),
    dropdown_item("Chlorohydration (H2O)",
                  "Cl<sub>2</sub> in H<sub>2</sub>O",
                  chlorohydrate_it_water),
    dropdown_item("Chlorohydration (EtOH)",
                  "Cl<sub>2</sub> in EtOH",
                  chlorohydrate_it_ethanol),
    dropdown_item("Chlorohydration (ROH)",
                  "Cl<sub>2</sub> in ROH",
                  chlorohydrate_it_auto),
    dropdown_item("Hydroboration-Oxidation",
                  "BH<sub>3</sub> in THF; then NaOH, H<sub>2</sub>O<sub>2</sub>",
                  hydroborate_oxidate_it),
    dropdown_item("Hydroboration",
                  "BH<sub>3</sub> in THF",
                  hydroborate_oxidate_it_1),
    dropdown_item("Oxidation",
                  "NaOH, H<sub>2</sub>O<sub>2</sub>",
                  hydroborate_oxidate_it_2),
    dropdown_item("Dihydroxylation",
                  "cat. OsO<sub>4</sub> in NMO or acetone",
                  dihydroxylate_it),
    dropdown_item("Ozonolysis",
                  "O<sub>3</sub> in CH<sub>2</sub>Cl<sub>2</sub>, then Me<sub>2</sub>S or Zn",
                  ozonolyse_it),
    dropdown_item("Sodium-Ammonia Reduction",
                  "Na in NH<sub>3(l)</sub>",
                  sodium_ammonia_it),
    dropdown_item("Lindlar Reduction",
                  "H<sub>2</sub> cat. Lindlar",
                  lindlar_it),
    dropdown_item("Acetylide Formation",
                  "NaNH<sub>2</sub> in NH<sub>3</sub>",
                  alkyne_deprotonate_it),
    dropdown_item("Tert-butoxide Elimination",
                  "KOC(CH<sub>3</sub>)<sub>3</sub> (aka KOtBu)",
                  tert_butoxide_it),
    dropdown_item("Acetylide Addition",
                  "(no reagents)",
                  acetylide_add_it),
    dropdown_item("Hydrogenation",
                  "H<sub>2</sub> cat. Pd/C in EtOH",
                  hydrogenate_it),
    dropdown_item("Free-radical Hydrobromination",
                  "HBr cat. ROOR (peroxide), with heat or light",
                  radical_hydrobrominate_it),
]
